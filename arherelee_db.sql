...
ALTER TABLE `staff_info`
  ...
  ADD KEY `vehicle_id` (`vehicle_id`,`positon_id`),
...
--
ALTER TABLE `staff_info`
  MODIFY `staff_id` int(7) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `staff_info`
  ADD CONSTRAINT `staff_info_ibfk_1` FOREIGN KEY (`positon_id`) REFERENCES `staff_position` (`position_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `staff_info_ibfk_2` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`vehicle_id`) ON DELETE CASCADE ON UPDATE CASCADE;
